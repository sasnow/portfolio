...
Saved users multiple days of rework by ensuring data files met all requirements prior to submission.
...
Developed a Python-based NLP tool that processed asset descriptions to generate keyword lists for use in a search application.
